package yoginolja.utils;

public class ResponseMessage {
    public static final String READ_USER = "회원 정보 조회 성공";
    public static final String ALREADY_ID = "이미 존재하는 아이디입니다.";
    public static final String ID_CHECK_OK = "가입 가능한 아이디입니다.";
    ...
    public static final String GET_CAMP_INFORMATION_SUCCESS = "캠프 정보 조회 성공";
    public static final String POST_CAMP_INFORMATION_SUCCESS = "캠프 정보 등록 성공";
    public static final String UPDATE_CAMP_INFORMATION_SUCCESS = "캠프 정보 업데이트 성공";
    public static final String INVALID_CAMP_INFORMATION  = "캠프 등록/수정 정보가 잘못되었습니다.";
    public static final String GET_CAMP_LIST_SUCCESS = "캠프 리스트 조회 성공";
    public static final String NO_CONDITION_CAMP_LIST = "조건에 맞는 캠프 정보가 없습니다.";
    public static final String INVALID_CAMP_SEARCH_INPUT = "입력값을 잘못 입력하였습니다.";

    public static final String ADD_RESERVATION_SUCCESS =  "예약 요청 성공";
